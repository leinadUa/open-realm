...
#define PORTRAIT_HP_X PORTRAIT_X
#define PORTRAIT_HP_Y (PORTRAIT_Y + PORTRAIT_SIZE + 0.0005f)
#define PORTRAIT_HP_W PORTRAIT_SIZE
#define PORTRAIT_HP_H 0.0140f
#define PORTRAIT_MANA_X PORTRAIT_X
#define PORTRAIT_MANA_Y (PORTRAIT_HP_Y + PORTRAIT_HP_H)
#define PORTRAIT_MANA_W PORTRAIT_SIZE
#define PORTRAIT_MANA_H 0.0140f
